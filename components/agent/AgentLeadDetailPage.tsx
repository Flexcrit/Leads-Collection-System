...
interface AgentLeadDetailPageProps {
  user: UserProfile
  leadId: string
}

export default function AgentLeadDetailPage({ user, leadId }: AgentLeadDetailPageProps) {
  ...
  return (
    <DashboardLayout user={user}>
      ...
      {/* Feedback Section */}
      <div className="mt-8">
        <h2 className="text-lg font-semibold text-slate-900 mb-4">Feedback & Communication</h2>
